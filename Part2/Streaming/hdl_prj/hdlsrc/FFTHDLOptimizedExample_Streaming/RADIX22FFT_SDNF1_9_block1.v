// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDNF1_9_block1.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDNF1_9_block1
...
module RADIX22FFT_SDNF1_9_block1
  ...
  input   clk;
  input   reset;
  input   signed [23:0] dout_5_re;  // sfix24_En13
  input   signed [23:0] dout_5_im;  // sfix24_En13
  input   signed [23:0] dout_7_re;  // sfix24_En13
  input   signed [23:0] dout_7_im;  // sfix24_En13
  input   dout_8_vld;
  input   signed [15:0] twdl_9_6_re;  // sfix16_En14
  input   signed [15:0] twdl_9_6_im;  // sfix16_En14
  output  signed [24:0] dout_5_re_1;  // sfix25_En13
  output  signed [24:0] dout_5_im_1;  // sfix25_En13
  output  signed [24:0] dout_6_re;  // sfix25_En13
  output  signed [24:0] dout_6_im;  // sfix25_En13
  ...
  reg signed [24:0] dout_5_re_2;  // sfix25_En13
  reg signed [24:0] dout_5_im_2;  // sfix25_En13
  reg signed [24:0] dout_6_re_1;  // sfix25_En13
  reg signed [24:0] dout_6_im_1;  // sfix25_En13
  reg  dout_6_vld;
  ...
  assign din_re = {dout_5_re[23], dout_5_re};
  ...
  assign din_im = {dout_5_im[23], dout_5_im};
  ...
  assign din_re_1 = {dout_7_re[23], dout_7_re};
  ...
  assign din_im_1 = {dout_7_im[23], dout_7_im};
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    dout_5_re_2 = Radix22ButterflyG1_NF_btf1_re_reg[24:0];
    dout_5_im_2 = Radix22ButterflyG1_NF_btf1_im_reg[24:0];
    dout_6_re_1 = Radix22ButterflyG1_NF_btf2_re_reg[24:0];
    dout_6_im_1 = Radix22ButterflyG1_NF_btf2_im_reg[24:0];
...
endmodule  // RADIX22FFT_SDNF1_9_block1
