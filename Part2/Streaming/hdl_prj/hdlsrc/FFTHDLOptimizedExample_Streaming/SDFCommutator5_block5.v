// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator5_block5.v
...
module SDFCommutator5_block5
  ...
  output  wrAddr;  // ufix1
  output  wrEnb;
  output  signed [20:0] dout_5_7_re;  // sfix21_En13
  output  signed [20:0] dout_5_7_im;  // sfix21_En13
  ...
  reg signed [20:0] dout_5_7_re_1;  // sfix21_En13
  reg signed [20:0] dout_5_7_im_1;  // sfix21_En13
  reg  dout_5_7_vld;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_5_7_re_1 = SDFOutmux_btf2Pipe_re;
    dout_5_7_im_1 = SDFOutmux_btf2Pipe_im;
    dout_5_7_vld = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_5_7_re = dout_5_7_re_1;

  assign dout_5_7_im = dout_5_7_im_1;

endmodule  // SDFCommutator5_block5
