// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDNF2_8.v
...
module RADIX22FFT_SDNF2_8
  ...
  input   signed [22:0] dout_1_re;  // sfix23_En13
  input   signed [22:0] dout_1_im;  // sfix23_En13
  input   signed [22:0] dout_5_re;  // sfix23_En13
  input   signed [22:0] dout_5_im;  // sfix23_En13
  input   dout_1_vld;
  output  signed [23:0] dout_1_re_1;  // sfix24_En13
  output  signed [23:0] dout_1_im_1;  // sfix24_En13
  output  signed [23:0] dout_2_re;  // sfix24_En13
  output  signed [23:0] dout_2_im;  // sfix24_En13
  output  dout_8_vld;
  ...
  reg signed [23:0] dout_1_re_2;  // sfix24_En13
  reg signed [23:0] dout_1_im_2;  // sfix24_En13
  reg signed [23:0] dout_2_re_1;  // sfix24_En13
  reg signed [23:0] dout_2_im_1;  // sfix24_En13
  reg  dout_8_vld_1;
  ...
  assign din1_re = {dout_1_re[22], dout_1_re};



  assign din1_im = {dout_1_im[22], dout_1_im};



  assign din2_re = {dout_5_re[22], dout_5_re};



  assign din2_im = {dout_5_im[22], dout_5_im};
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
    ...
    dout_1_re_2 = Radix22ButterflyG2_NF_btf1_re_reg[23:0];
    dout_1_im_2 = Radix22ButterflyG2_NF_btf1_im_reg[23:0];
    dout_2_re_1 = Radix22ButterflyG2_NF_btf2_re_reg[23:0];
    dout_2_im_1 = Radix22ButterflyG2_NF_btf2_im_reg[23:0];
    dout_8_vld_1 = Radix22ButterflyG2_NF_din_vld_dly;
  end
  ...
  assign dout_8_vld = dout_8_vld_1;

endmodule  // RADIX22FFT_SDNF2_8
