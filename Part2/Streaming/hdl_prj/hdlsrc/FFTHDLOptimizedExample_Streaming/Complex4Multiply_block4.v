// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\Complex4Multiply_block4.v
...
module Complex4Multiply_block4
  ...
  always @(posedge clk or posedge reset)
    begin : Complex4Add_process
      if (reset == 1'b1) begin
        ...
        dinXTwdl_3_6_vld_1 <= Complex4Add_prod_vld_reg1;
  ...
  assign dinXTwdl_3_6_vld = dinXTwdl_3_6_vld_1;

endmodule  // Complex4Multiply_block4
