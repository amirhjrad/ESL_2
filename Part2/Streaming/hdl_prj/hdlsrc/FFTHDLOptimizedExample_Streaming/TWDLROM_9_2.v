// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\TWDLROM_9_2.v
...
// 
// Module: TWDLROM_9_2
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/TWDLROM_9_2
// Hierarchy Level: 2
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module TWDLROM_9_2
  ...
  input   reset;
  input   dout_8_vld;
  output  signed [15:0] twdl_9_2_re;  // sfix16_En14
  output  signed [15:0] twdl_9_2_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_9_2_re_1;  // sfix16_En14
  reg signed [15:0] twdl_9_2_im_1;  // sfix16_En14
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_9_2_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_9_2_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_9_2_re = twdl_9_2_re_1;

  assign twdl_9_2_im = twdl_9_2_im_1;

endmodule  // TWDLROM_9_2
