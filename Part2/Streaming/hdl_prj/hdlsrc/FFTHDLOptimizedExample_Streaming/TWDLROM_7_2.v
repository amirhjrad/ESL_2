// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\TWDLROM_7_2.v
...
// 
// Module: TWDLROM_7_2
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/TWDLROM_7_2
// Hierarchy Level: 2
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module TWDLROM_7_2
  ...
  input   reset;
  input   dout_6_1_vld;
  output  signed [15:0] twdl_7_2_re;  // sfix16_En14
  output  signed [15:0] twdl_7_2_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_7_2_re_1;  // sfix16_En14
  reg signed [15:0] twdl_7_2_im_1;  // sfix16_En14
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_dvldReg1,
    ...
    if (dout_6_1_vld && (Radix22TwdlMapping_cnt > 7'b0000000)) begin
      Radix22TwdlMapping_phase_next = Radix22TwdlMapping_phase + 2'b01;
    end
    Radix22TwdlMapping_cnt_next = 7'b0010000;
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_7_2_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_7_2_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_7_2_re = twdl_7_2_re_1;

  assign twdl_7_2_im = twdl_7_2_im_1;

endmodule  // TWDLROM_7_2
