// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_2_block4.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF2_2_block4
...
module RADIX22FFT_SDF2_2_block4
  ...
  input   clk;
  input   reset;
  input   signed [16:0] dout_1_6_re;  // sfix17_En13
  input   signed [16:0] dout_1_6_im;  // sfix17_En13
  input   dout_1_1_vld;
  input   [3:0] rd_2_Addr;  // ufix4
  input   rd_2_Enb;
  input   proc_2_enb;
  input   multiply_2_J;
  output  signed [17:0] dout_2_6_re;  // sfix18_En13
  output  signed [17:0] dout_2_6_im;  // sfix18_En13
  ...
  assign din_re = {dout_1_6_re[16], dout_1_6_re};



  assign din_im = {dout_1_6_im[16], dout_1_6_im};
  ...
  SDFCommutator2_block4 u_SDFCOMMUTATOR_2 (.clk(clk),
                                           .reset(reset),
...
endmodule  // RADIX22FFT_SDF2_2_block4
