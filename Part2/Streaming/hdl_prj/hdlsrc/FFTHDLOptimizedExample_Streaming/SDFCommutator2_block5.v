// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator2_block5.v
...
module SDFCommutator2_block5
  ...
  reg signed [17:0] dout_2_7_re_1;  // sfix18_En13
  reg signed [17:0] dout_2_7_im_1;  // sfix18_En13
  reg  dout_2_7_vld;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_2_7_re_1 = SDFOutmux_btf2Pipe_re;
    dout_2_7_im_1 = SDFOutmux_btf2Pipe_im;
    dout_2_7_vld = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_2_7_re = dout_2_7_re_1;

  assign dout_2_7_im = dout_2_7_im_1;

endmodule  // SDFCommutator2_block5
