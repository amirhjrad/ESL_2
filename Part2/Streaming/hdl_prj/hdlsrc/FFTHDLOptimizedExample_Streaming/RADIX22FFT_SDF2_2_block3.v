// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_2_block3.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF2_2_block3
...
module RADIX22FFT_SDF2_2_block3
  ...
  input   clk;
  input   reset;
  input   signed [16:0] dout_1_5_re;  // sfix17_En13
  input   signed [16:0] dout_1_5_im;  // sfix17_En13
  input   dout_1_1_vld;
  ...
  assign din_re = {dout_1_5_re[16], dout_1_5_re};



  assign din_im = {dout_1_5_im[16], dout_1_5_im};
  ...
  SDFCommutator2_block3 u_SDFCOMMUTATOR_2 (.clk(clk),
                                           .reset(reset),
...
endmodule  // RADIX22FFT_SDF2_2_block3
