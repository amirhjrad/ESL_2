// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_3_block6.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF1_3_block6
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/RADIX22FFT_SDF1_3
// Hierarchy Level: 2
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module RADIX22FFT_SDF1_3_block6
  ...
  input   clk;
  input   reset;
  input   signed [17:0] din_3_8_re_dly;  // sfix18_En13
  input   signed [17:0] din_3_8_im_dly;  // sfix18_En13
  input   din_3_vld_dly;
  input   [2:0] rd_3_Addr;  // ufix3
  input   rd_3_Enb;
  input   signed [15:0] twdl_3_8_re;  // sfix16_En14
  input   signed [15:0] twdl_3_8_im;  // sfix16_En14
  input   proc_3_enb;
  output  signed [18:0] dout_3_8_re;  // sfix19_En13
  output  signed [18:0] dout_3_8_im;  // sfix19_En13
  ...
  assign din_re = {din_3_8_re_dly[17], din_3_8_re_dly};



  assign din_im = {din_3_8_im_dly[17], din_3_8_im_dly};



  Complex4Multiply_block6 u_MUL4 (.clk(clk),
                                  .reset(reset),
                                  ...
                                  .dinXTwdl_3_8_vld(dinXTwdl_3_8_vld)
                                  );
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22ButterflyG1_process
      if (reset == 1'b1) begin
        ...
        Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_3_enb && dinXTwdl_3_8_vld;
      end
    end

  assign dinxTwdlf_vld = ( ! proc_3_enb) && dinXTwdl_3_8_vld;
  ...
  SDFCommutator3_block6 u_SDFCOMMUTATOR_3 (.clk(clk),
                                           .reset(reset),
                                           .din_3_vld_dly(din_3_vld_dly),
...
endmodule  // RADIX22FFT_SDF1_3_block6
