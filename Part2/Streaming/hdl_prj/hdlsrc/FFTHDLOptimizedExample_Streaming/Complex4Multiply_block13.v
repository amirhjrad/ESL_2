// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\Complex4Multiply_block13.v
...
module Complex4Multiply_block13
  ...
  always @(posedge clk or posedge reset)
    begin : Complex4Add_process
      if (reset == 1'b1) begin
        ...
        dinXTwdl_5_7_vld_1 <= Complex4Add_prod_vld_reg1;
  ...
  assign dinXTwdl_5_7_vld = dinXTwdl_5_7_vld_1;

endmodule  // Complex4Multiply_block13
