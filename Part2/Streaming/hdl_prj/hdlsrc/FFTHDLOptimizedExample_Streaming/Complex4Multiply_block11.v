// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\Complex4Multiply_block11.v
...
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/RADIX22FFT_SDF1_5/Complex4Multiply
// Hierarchy Level: 3
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module Complex4Multiply_block11
  ...
  input   clk;
  input   reset;
  input   signed [20:0] din_re;  // sfix21_En13
  input   signed [20:0] din_im;  // sfix21_En13
  input   din_5_vld_dly;
  input   signed [15:0] twdl_5_5_re;  // sfix16_En14
  input   signed [15:0] twdl_5_5_im;  // sfix16_En14
  output  signed [20:0] dinXTwdl_re;  // sfix21_En13
  output  signed [20:0] dinXTwdl_im;  // sfix21_En13
  output  dinXTwdl_5_5_vld;


  reg signed [20:0] din_re_reg;  // sfix21_En13
  reg signed [20:0] din_im_reg;  // sfix21_En13
  ...
  reg signed [36:0] prod1_re;  // sfix37_En27
  reg signed [36:0] prod1_im;  // sfix37_En27
  reg signed [36:0] prod2_re;  // sfix37_En27
  reg signed [36:0] prod2_im;  // sfix37_En27
  reg  din_vld_dly1;
  reg  din_vld_dly2;
  reg  din_vld_dly3;
  reg  prod_vld;
  ...
  wire signed [37:0] Complex4Add_multRes_re_reg_next;  // sfix38_En27
  wire signed [37:0] Complex4Add_multRes_im_reg_next;  // sfix38_En27
  wire signed [37:0] Complex4Add_sub_cast;  // sfix38_En27
  wire signed [37:0] Complex4Add_sub_cast_1;  // sfix38_En27
  wire signed [37:0] Complex4Add_add_cast;  // sfix38_En27
  wire signed [37:0] Complex4Add_add_cast_1;  // sfix38_En27
  wire signed [37:0] mulResFP_re;  // sfix38_En27
  wire signed [37:0] mulResFP_im;  // sfix38_En27
  reg  dinXTwdl_5_5_vld_1;
  ...
  always @(posedge clk or posedge reset)
    begin : Complex4Add_process
      if (reset == 1'b1) begin
        ...
        dinXTwdl_5_5_vld_1 <= Complex4Add_prod_vld_reg1;
  ...
  assign dinXTwdl_re = mulResFP_re[34:14];



  assign dinXTwdl_im = mulResFP_im[34:14];



  assign dinXTwdl_5_5_vld = dinXTwdl_5_5_vld_1;

endmodule  // Complex4Multiply_block11
