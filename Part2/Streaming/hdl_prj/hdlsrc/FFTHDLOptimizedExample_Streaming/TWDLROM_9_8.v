// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\TWDLROM_9_8.v
...
// 
// Module: TWDLROM_9_8
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/TWDLROM_9_8
// Hierarchy Level: 2
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module TWDLROM_9_8
  ...
  input   reset;
  input   dout_8_vld;
  output  signed [15:0] twdl_9_8_re;  // sfix16_En14
  output  signed [15:0] twdl_9_8_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_9_8_re_1;  // sfix16_En14
  reg signed [15:0] twdl_9_8_im_1;  // sfix16_En14
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22TwdlMapping_process
      if (reset == 1'b1) begin
        ...
        Radix22TwdlMapping_phase <= 2'b11;
      end
      else begin
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_dvldReg1,
    ...
    Radix22TwdlMapping_phase_next = 2'b11;
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_9_8_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_9_8_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_9_8_re = twdl_9_8_re_1;

  assign twdl_9_8_im = twdl_9_8_im_1;

endmodule  // TWDLROM_9_8
