// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_3_block1.v
...
module RADIX22FFT_SDF1_3_block1
  ...
  input   clk;
  input   reset;
  input   signed [17:0] din_3_3_re_dly;  // sfix18_En13
  input   signed [17:0] din_3_3_im_dly;  // sfix18_En13
  input   din_3_vld_dly;
  ...
  input   proc_3_enb;
  output  signed [18:0] dout_3_3_re;  // sfix19_En13
  output  signed [18:0] dout_3_3_im;  // sfix19_En13
  ...
  assign din_re = {din_3_3_re_dly[17], din_3_3_re_dly};



  assign din_im = {din_3_3_im_dly[17], din_3_3_im_dly};
  ...
  Complex4Multiply_block1 u_MUL4 (.clk(clk),
                                  ...
                                  .dinXTwdl_3_3_vld(dinXTwdl_3_3_vld)
                                  );
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22ButterflyG1_process
      if (reset == 1'b1) begin
        ...
        Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_3_enb && dinXTwdl_3_3_vld;
      end
    end

  assign dinxTwdlf_vld = ( ! proc_3_enb) && dinXTwdl_3_3_vld;
