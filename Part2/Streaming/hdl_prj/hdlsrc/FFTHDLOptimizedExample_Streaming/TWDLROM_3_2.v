// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\TWDLROM_3_2.v
...
// 
// Module: TWDLROM_3_2
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/TWDLROM_3_2
// Hierarchy Level: 2
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module TWDLROM_3_2
  ...
  input   reset;
  input   dout_2_1_vld;
  output  signed [15:0] twdl_3_2_re;  // sfix16_En14
  output  signed [15:0] twdl_3_2_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_3_2_re_1;  // sfix16_En14
  reg signed [15:0] twdl_3_2_im_1;  // sfix16_En14
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22TwdlMapping_process
      if (reset == 1'b1) begin
        ...
        Radix22TwdlMapping_cnt <= 7'b0000001;
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_3_2_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_3_2_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_3_2_re = twdl_3_2_re_1;

  assign twdl_3_2_im = twdl_3_2_im_1;

endmodule  // TWDLROM_3_2
