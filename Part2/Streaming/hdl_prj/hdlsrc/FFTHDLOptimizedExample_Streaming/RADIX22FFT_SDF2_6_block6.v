// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_6_block6.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF2_6_block6
...
module RADIX22FFT_SDF2_6_block6
  ...
  input   clk;
  input   reset;
  input   signed [20:0] dout_5_8_re;  // sfix21_En13
  input   signed [20:0] dout_5_8_im;  // sfix21_En13
  input   dout_5_1_vld;
  input   rd_6_Addr;
  input   rd_6_Enb;
  input   proc_6_enb;
  input   multiply_6_J;
  output  signed [21:0] dout_6_8_re;  // sfix22_En13
  output  signed [21:0] dout_6_8_im;  // sfix22_En13
  ...
  assign din_re = {dout_5_8_re[20], dout_5_8_re};



  assign din_im = {dout_5_8_im[20], dout_5_8_im};
  ...
  SDFCommutator6_block6 u_SDFCOMMUTATOR_6 (.clk(clk),
                                           .reset(reset),
...
endmodule  // RADIX22FFT_SDF2_6_block6
