// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_6_block3.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF2_6_block3
...
module RADIX22FFT_SDF2_6_block3
  ...
  input   clk;
  input   reset;
  input   signed [20:0] dout_5_5_re;  // sfix21_En13
  input   signed [20:0] dout_5_5_im;  // sfix21_En13
  input   dout_5_1_vld;
  input   rd_6_Addr;
  input   rd_6_Enb;
  input   proc_6_enb;
  ...
  assign din_re = {dout_5_5_re[20], dout_5_5_re};



  assign din_im = {dout_5_5_im[20], dout_5_5_im};
  ...
  SDFCommutator6_block3 u_SDFCOMMUTATOR_6 (.clk(clk),
                                           .reset(reset),
...
endmodule  // RADIX22FFT_SDF2_6_block3
