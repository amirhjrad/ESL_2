// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator4_block6.v
...
module SDFCommutator4_block6
  ...
  reg signed [19:0] dout_4_8_re_1;  // sfix20_En13
  reg signed [19:0] dout_4_8_im_1;  // sfix20_En13
  reg  dout_4_8_vld;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_4_8_re_1 = SDFOutmux_btf2Pipe_re;
    dout_4_8_im_1 = SDFOutmux_btf2Pipe_im;
    dout_4_8_vld = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_4_8_re = dout_4_8_re_1;

  assign dout_4_8_im = dout_4_8_im_1;

endmodule  // SDFCommutator4_block6
