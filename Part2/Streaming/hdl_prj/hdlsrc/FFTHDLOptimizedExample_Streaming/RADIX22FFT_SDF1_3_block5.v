// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_3_block5.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF1_3_block5
...
module RADIX22FFT_SDF1_3_block5
  ...
  input   clk;
  input   reset;
  input   signed [17:0] din_3_7_re_dly;  // sfix18_En13
  input   signed [17:0] din_3_7_im_dly;  // sfix18_En13
  input   din_3_vld_dly;
  ...
  assign din_re = {din_3_7_re_dly[17], din_3_7_re_dly};



  assign din_im = {din_3_7_im_dly[17], din_3_7_im_dly};
  ...
  Complex4Multiply_block5 u_MUL4 (.clk(clk),
                                  ...
                                  .dinXTwdl_3_7_vld(dinXTwdl_3_7_vld)
                                  );
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22ButterflyG1_process
      if (reset == 1'b1) begin
        ...
        Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_3_enb && dinXTwdl_3_7_vld;
      end
    end

  assign dinxTwdlf_vld = ( ! proc_3_enb) && dinXTwdl_3_7_vld;
  ...
  SDFCommutator3_block5 u_SDFCOMMUTATOR_3 (.clk(clk),
                                           .reset(reset),
                                           .din_3_vld_dly(din_3_vld_dly),
...
endmodule  // RADIX22FFT_SDF1_3_block5
