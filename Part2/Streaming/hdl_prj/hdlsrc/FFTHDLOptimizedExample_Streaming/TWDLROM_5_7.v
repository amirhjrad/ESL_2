// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\TWDLROM_5_7.v
...
// 
// Module: TWDLROM_5_7
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/TWDLROM_5_7
// Hierarchy Level: 2
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module TWDLROM_5_7
  ...
  input   reset;
  input   dout_4_1_vld;
  output  signed [15:0] twdl_5_7_re;  // sfix16_En14
  output  signed [15:0] twdl_5_7_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_5_7_re_1;  // sfix16_En14
  reg signed [15:0] twdl_5_7_im_1;  // sfix16_En14
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22TwdlMapping_process
      if (reset == 1'b1) begin
        ...
        Radix22TwdlMapping_cnt <= 7'b0011000;
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_5_7_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_5_7_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_5_7_re = twdl_5_7_re_1;

  assign twdl_5_7_im = twdl_5_7_im_1;

endmodule  // TWDLROM_5_7
