// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_5_block3.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF1_5_block3
...
module RADIX22FFT_SDF1_5_block3
  ...
  input   clk;
  input   reset;
  input   signed [19:0] din_5_5_re_dly;  // sfix20_En13
  input   signed [19:0] din_5_5_im_dly;  // sfix20_En13
  input   din_5_vld_dly;
  ...
  assign din_re = {din_5_5_re_dly[19], din_5_5_re_dly};



  assign din_im = {din_5_5_im_dly[19], din_5_5_im_dly};



  Complex4Multiply_block11 u_MUL4 (.clk(clk),
                                   .reset(reset),
                                   ...
                                   .dinXTwdl_5_5_vld(dinXTwdl_5_5_vld)
                                   );
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22ButterflyG1_process
      if (reset == 1'b1) begin
        ...
        Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_5_enb && dinXTwdl_5_5_vld;
      end
    end

  assign dinxTwdlf_vld = ( ! proc_5_enb) && dinXTwdl_5_5_vld;
  ...
  SDFCommutator5_block3 u_SDFCOMMUTATOR_5 (.clk(clk),
                                           .reset(reset),
                                           .din_5_vld_dly(din_5_vld_dly),
...
endmodule  // RADIX22FFT_SDF1_5_block3
