// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator5_block6.v
...
// -------------------------------------------------------------
// 
// Module: SDFCommutator5_block6
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/RADIX22FFT_SDF1_5/SDFCommutator5
// Hierarchy Level: 3
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module SDFCommutator5_block6
  ...
  input   reset;
  input   din_5_vld_dly;
  input   signed [20:0] xf_re;  // sfix21_En13
  input   signed [20:0] xf_im;  // sfix21_En13
  input   xf_vld;
  input   signed [20:0] dinXTwdlf_re;  // sfix21_En13
  input   signed [20:0] dinXTwdlf_im;  // sfix21_En13
  input   dinxTwdlf_vld;
  input   signed [20:0] btf1_re;  // sfix21_En13
  input   signed [20:0] btf1_im;  // sfix21_En13
  input   signed [20:0] btf2_re;  // sfix21_En13
  input   signed [20:0] btf2_im;  // sfix21_En13
  input   btf_vld;
  output  signed [20:0] wrData_re;  // sfix21_En13
  output  signed [20:0] wrData_im;  // sfix21_En13
  output  wrAddr;  // ufix1
  output  wrEnb;
  output  signed [20:0] dout_5_8_re;  // sfix21_En13
  output  signed [20:0] dout_5_8_im;  // sfix21_En13


  reg signed [20:0] SDFCummutator_out_re;  // sfix21
  reg signed [20:0] SDFCummutator_out_im;  // sfix21
  reg  SDFCummutator_out_vld;
  reg  SDFCummutator_wrAddr_reg;  // ufix1
  reg [2:0] SDFCummutator_wrState;  // ufix3
  reg signed [20:0] SDFCummutator_wrData_re_reg;  // sfix21
  reg signed [20:0] SDFCummutator_wrData_im_reg;  // sfix21
  reg  SDFCummutator_wrEnb_reg;
  reg signed [20:0] SDFCummutator_wrXData_re_reg;  // sfix21
  reg signed [20:0] SDFCummutator_wrXData_im_reg;  // sfix21
  ...
  reg signed [20:0] SDFCummutator_out_re_next;  // sfix21_En13
  reg signed [20:0] SDFCummutator_out_im_next;  // sfix21_En13
  reg  SDFCummutator_out_vld_next;
  reg  SDFCummutator_wrAddr_reg_next;  // ufix1
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [20:0] SDFCummutator_wrData_re_reg_next;  // sfix21_En13
  reg signed [20:0] SDFCummutator_wrData_im_reg_next;  // sfix21_En13
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [20:0] SDFCummutator_wrXData_re_reg_next;  // sfix21_En13
  reg signed [20:0] SDFCummutator_wrXData_im_reg_next;  // sfix21_En13
  ...
  reg signed [20:0] wrData_re_1;  // sfix21_En13
  reg signed [20:0] wrData_im_1;  // sfix21_En13
  reg  wrAddr_1;  // ufix1
  reg  wrEnb_1;
  reg signed [20:0] xData_re;  // sfix21_En13
  reg signed [20:0] xData_im;  // sfix21_En13
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [20:0] dout0_re;  // sfix21_En13
  reg signed [20:0] dout0_im;  // sfix21_En13
  reg  dout0_vld;
  wire signed [20:0] xX_re;  // sfix21_En13
  wire signed [20:0] xX_im;  // sfix21_En13
  reg signed [20:0] SDFOutmux_btf2Pipe_re;  // sfix21
  reg signed [20:0] SDFOutmux_btf2Pipe_im;  // sfix21
  reg  SDFOutmux_btfPipe_vld;
  reg signed [20:0] SDFOutmux_btf2Pipe_re_next;  // sfix21_En13
  reg signed [20:0] SDFOutmux_btf2Pipe_im_next;  // sfix21_En13
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [20:0] dout_5_8_re_1;  // sfix21_En13
  reg signed [20:0] dout_5_8_im_1;  // sfix21_En13
  reg  dout_5_8_vld;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_5_8_re_1 = SDFOutmux_btf2Pipe_re;
    dout_5_8_im_1 = SDFOutmux_btf2Pipe_im;
    dout_5_8_vld = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_5_8_re = dout_5_8_re_1;

  assign dout_5_8_im = dout_5_8_im_1;

endmodule  // SDFCommutator5_block6
