// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_3_block4.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF1_3_block4
...
module RADIX22FFT_SDF1_3_block4
  ...
  input   clk;
  input   reset;
  input   signed [17:0] din_3_6_re_dly;  // sfix18_En13
  input   signed [17:0] din_3_6_im_dly;  // sfix18_En13
  input   din_3_vld_dly;
  ...
  input   proc_3_enb;
  output  signed [18:0] dout_3_6_re;  // sfix19_En13
  output  signed [18:0] dout_3_6_im;  // sfix19_En13
  ...
  assign din_re = {din_3_6_re_dly[17], din_3_6_re_dly};



  assign din_im = {din_3_6_im_dly[17], din_3_6_im_dly};
  ...
  Complex4Multiply_block4 u_MUL4 (.clk(clk),
                                  ...
                                  .dinXTwdl_3_6_vld(dinXTwdl_3_6_vld)
                                  );
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22ButterflyG1_process
      if (reset == 1'b1) begin
        ...
        Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_3_enb && dinXTwdl_3_6_vld;
      end
    end

  assign dinxTwdlf_vld = ( ! proc_3_enb) && dinXTwdl_3_6_vld;
  ...
  SDFCommutator3_block4 u_SDFCOMMUTATOR_3 (.clk(clk),
                                           .reset(reset),
                                           .din_3_vld_dly(din_3_vld_dly),
...
endmodule  // RADIX22FFT_SDF1_3_block4
