// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF1_1_block4.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF1_1_block4
...
module RADIX22FFT_SDF1_1_block4
  ...
  input   clk;
  input   reset;
  input   signed [15:0] din_1_6_re_dly;  // sfix16_En13
  input   signed [15:0] din_1_6_im_dly;  // sfix16_En13
  input   din_1_vld_dly;
  ...
  assign din_re = {din_1_6_re_dly[15], din_1_6_re_dly};
  ...
  assign din_im = {din_1_6_im_dly[15], din_1_6_im_dly};
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_2_process
      if (reset == 1'b1) begin
        dinXTwdl_1_6_vld <= 1'b0;
      end
      else begin
        dinXTwdl_1_6_vld <= din_1_vld_dly;
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22ButterflyG1_process
      if (reset == 1'b1) begin
        ...
        Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_1_enb && dinXTwdl_1_6_vld;
      end
    end

  assign dinxTwdlf_vld = ( ! proc_1_enb) && dinXTwdl_1_6_vld;
  ...
  SDFCommutator1_block4 u_SDFCOMMUTATOR_1 (.clk(clk),
                                           .reset(reset),
...
endmodule  // RADIX22FFT_SDF1_1_block4
