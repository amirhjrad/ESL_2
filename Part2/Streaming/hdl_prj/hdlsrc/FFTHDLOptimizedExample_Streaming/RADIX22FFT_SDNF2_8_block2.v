// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDNF2_8_block2.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDNF2_8_block2
...
module RADIX22FFT_SDNF2_8_block2
  ...
  input   clk;
  input   reset;
  input   rotate_7;  // ufix1
  input   signed [22:0] dout_4_re;  // sfix23_En13
  input   signed [22:0] dout_4_im;  // sfix23_En13
  input   signed [22:0] dout_8_re;  // sfix23_En13
  input   signed [22:0] dout_8_im;  // sfix23_En13
  input   dout_1_vld;
  output  signed [23:0] dout_7_re;  // sfix24_En13
  output  signed [23:0] dout_7_im;  // sfix24_En13
  output  signed [23:0] dout_8_re_1;  // sfix24_En13
  output  signed [23:0] dout_8_im_1;  // sfix24_En13
  ...
  reg signed [23:0] dout_7_re_1;  // sfix24_En13
  reg signed [23:0] dout_7_im_1;  // sfix24_En13
  reg signed [23:0] dout_8_re_2;  // sfix24_En13
  reg signed [23:0] dout_8_im_2;  // sfix24_En13
  reg  dout_8_vld;
  ...
  assign din1_re = {dout_4_re[22], dout_4_re};



  assign din1_im = {dout_4_im[22], dout_4_im};



  assign din2_re = {dout_8_re[22], dout_8_re};



  assign din2_im = {dout_8_im[22], dout_8_im};
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
    ...
    dout_7_re_1 = Radix22ButterflyG2_NF_btf1_re_reg[23:0];
    dout_7_im_1 = Radix22ButterflyG2_NF_btf1_im_reg[23:0];
    dout_8_re_2 = Radix22ButterflyG2_NF_btf2_re_reg[23:0];
    dout_8_im_2 = Radix22ButterflyG2_NF_btf2_im_reg[23:0];
...
endmodule  // RADIX22FFT_SDNF2_8_block2
