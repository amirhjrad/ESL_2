// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDNF1_9_block2.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDNF1_9_block2
...
module RADIX22FFT_SDNF1_9_block2
  ...
  input   clk;
  input   reset;
  input   signed [23:0] dout_6_re;  // sfix24_En13
  input   signed [23:0] dout_6_im;  // sfix24_En13
  input   signed [23:0] dout_8_re;  // sfix24_En13
  input   signed [23:0] dout_8_im;  // sfix24_En13
  input   dout_8_vld;
  input   signed [15:0] twdl_9_8_re;  // sfix16_En14
  input   signed [15:0] twdl_9_8_im;  // sfix16_En14
  output  signed [24:0] dout_7_re;  // sfix25_En13
  output  signed [24:0] dout_7_im;  // sfix25_En13
  output  signed [24:0] dout_8_re_1;  // sfix25_En13
  output  signed [24:0] dout_8_im_1;  // sfix25_En13
  ...
  reg signed [24:0] dout_7_re_1;  // sfix25_En13
  reg signed [24:0] dout_7_im_1;  // sfix25_En13
  reg signed [24:0] dout_8_re_2;  // sfix25_En13
  reg signed [24:0] dout_8_im_2;  // sfix25_En13
  reg  dout_8_vld_1;
  ...
  assign din_re = {dout_6_re[23], dout_6_re};
  ...
  assign din_im = {dout_6_im[23], dout_6_im};
  ...
  assign din_re_1 = {dout_8_re[23], dout_8_re};
  ...
  assign din_im_1 = {dout_8_im[23], dout_8_im};
  ...
  Complex4Multiply_block25 u_MUL4_2 (.clk(clk),
                                     .reset(reset),
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    dout_7_re_1 = Radix22ButterflyG1_NF_btf1_re_reg[24:0];
    dout_7_im_1 = Radix22ButterflyG1_NF_btf1_im_reg[24:0];
    dout_8_re_2 = Radix22ButterflyG1_NF_btf2_re_reg[24:0];
    dout_8_im_2 = Radix22ButterflyG1_NF_btf2_im_reg[24:0];
    dout_8_vld_1 = Radix22ButterflyG1_NF_dinXtwdl_vld_dly1;
  end
  ...
  assign dout_8_re_1 = dout_8_re_2;

  assign dout_8_im_1 = dout_8_im_2;

endmodule  // RADIX22FFT_SDNF1_9_block2
