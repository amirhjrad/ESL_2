// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDF2_6_block4.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDF2_6_block4
...
module RADIX22FFT_SDF2_6_block4
  ...
  input   clk;
  input   reset;
  input   signed [20:0] dout_5_6_re;  // sfix21_En13
  input   signed [20:0] dout_5_6_im;  // sfix21_En13
  input   dout_5_1_vld;
  input   rd_6_Addr;
  input   rd_6_Enb;
  input   proc_6_enb;
  input   multiply_6_J;
  output  signed [21:0] dout_6_6_re;  // sfix22_En13
  output  signed [21:0] dout_6_6_im;  // sfix22_En13
  ...
  assign din_re = {dout_5_6_re[20], dout_5_6_re};



  assign din_im = {dout_5_6_im[20], dout_5_6_im};
  ...
  SDFCommutator6_block4 u_SDFCOMMUTATOR_6 (.clk(clk),
                                           .reset(reset),
...
endmodule  // RADIX22FFT_SDF2_6_block4
