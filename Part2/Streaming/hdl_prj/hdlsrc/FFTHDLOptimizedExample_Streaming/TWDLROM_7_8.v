// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\TWDLROM_7_8.v
...
// 
// Module: TWDLROM_7_8
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/TWDLROM_7_8
// Hierarchy Level: 2
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module TWDLROM_7_8
  ...
  input   reset;
  input   dout_6_1_vld;
  output  signed [15:0] twdl_7_8_re;  // sfix16_En14
  output  signed [15:0] twdl_7_8_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_7_8_re_1;  // sfix16_En14
  reg signed [15:0] twdl_7_8_im_1;  // sfix16_En14
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22TwdlMapping_process
      if (reset == 1'b1) begin
        ...
        Radix22TwdlMapping_cnt <= 7'b1110000;
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_dvldReg1,
    ...
    Radix22TwdlMapping_cnt_next = 7'b1110000;
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_7_8_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_7_8_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_7_8_re = twdl_7_8_re_1;

  assign twdl_7_8_im = twdl_7_8_im_1;

endmodule  // TWDLROM_7_8
