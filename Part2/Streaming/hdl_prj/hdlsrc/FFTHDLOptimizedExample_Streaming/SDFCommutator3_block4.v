// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator3_block4.v
...
module SDFCommutator3_block4
  ...
  reg signed [18:0] dout_3_6_re_1;  // sfix19_En13
  reg signed [18:0] dout_3_6_im_1;  // sfix19_En13
  reg  dout_3_6_vld;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_3_6_re_1 = SDFOutmux_btf2Pipe_re;
    dout_3_6_im_1 = SDFOutmux_btf2Pipe_im;
    dout_3_6_vld = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_3_6_re = dout_3_6_re_1;

  assign dout_3_6_im = dout_3_6_im_1;

endmodule  // SDFCommutator3_block4
