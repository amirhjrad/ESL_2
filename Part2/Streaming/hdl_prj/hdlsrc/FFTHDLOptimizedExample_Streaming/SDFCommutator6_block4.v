// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator6_block4.v
...
module SDFCommutator6_block4
  ...
  reg signed [21:0] dout_6_6_re_1;  // sfix22_En13
  reg signed [21:0] dout_6_6_im_1;  // sfix22_En13
  reg  dout_6_6_vld;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_6_6_re_1 = SDFOutmux_btf2Pipe_re;
    dout_6_6_im_1 = SDFOutmux_btf2Pipe_im;
    dout_6_6_vld = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_6_6_re = dout_6_6_re_1;

  assign dout_6_6_im = dout_6_6_im_1;

endmodule  // SDFCommutator6_block4
