// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\RADIX22FFT_SDNF1_9_block.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDNF1_9_block
...
module RADIX22FFT_SDNF1_9_block
  ...
  input   clk;
  input   reset;
  input   signed [23:0] dout_2_re;  // sfix24_En13
  input   signed [23:0] dout_2_im;  // sfix24_En13
  input   signed [23:0] dout_4_re;  // sfix24_En13
  input   signed [23:0] dout_4_im;  // sfix24_En13
  input   dout_8_vld;
  input   signed [15:0] twdl_9_4_re;  // sfix16_En14
  input   signed [15:0] twdl_9_4_im;  // sfix16_En14
  output  signed [24:0] dout_3_re;  // sfix25_En13
  output  signed [24:0] dout_3_im;  // sfix25_En13
  output  signed [24:0] dout_4_re_1;  // sfix25_En13
  output  signed [24:0] dout_4_im_1;  // sfix25_En13
  ...
  reg signed [24:0] dout_3_re_1;  // sfix25_En13
  reg signed [24:0] dout_3_im_1;  // sfix25_En13
  reg signed [24:0] dout_4_re_2;  // sfix25_En13
  reg signed [24:0] dout_4_im_2;  // sfix25_En13
  reg  dout_4_vld;
  ...
  assign din_re = {dout_2_re[23], dout_2_re};
  ...
  assign din_im = {dout_2_im[23], dout_2_im};
  ...
  assign din_re_1 = {dout_4_re[23], dout_4_re};
  ...
  assign din_im_1 = {dout_4_im[23], dout_4_im};
  ...
  Complex4Multiply_block23 u_MUL4_2 (.clk(clk),
                                     .reset(reset),
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    dout_3_re_1 = Radix22ButterflyG1_NF_btf1_re_reg[24:0];
    dout_3_im_1 = Radix22ButterflyG1_NF_btf1_im_reg[24:0];
    dout_4_re_2 = Radix22ButterflyG1_NF_btf2_re_reg[24:0];
    dout_4_im_2 = Radix22ButterflyG1_NF_btf2_im_reg[24:0];
    dout_4_vld = Radix22ButterflyG1_NF_dinXtwdl_vld_dly1;
  end
  ...
  assign dout_4_re_1 = dout_4_re_2;

  assign dout_4_im_1 = dout_4_im_2;

endmodule  // RADIX22FFT_SDNF1_9_block
