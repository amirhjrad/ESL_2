// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\FFTHDLOptimizedExample_Streaming\SDFCommutator1_block6.v
...
// -------------------------------------------------------------
// 
// Module: SDFCommutator1_block6
// Source Path: FFTHDLOptimizedExample_Streaming/FFT Streaming/FFT/RADIX22FFT_SDF1_1/SDFCommutator1
// Hierarchy Level: 3
// Model version: 8.0
// 
// -------------------------------------------------------------
...
module SDFCommutator1_block6
  ...
  input   reset;
  input   din_1_vld_dly;
  input   signed [16:0] xf_re;  // sfix17_En13
  input   signed [16:0] xf_im;  // sfix17_En13
  input   xf_vld;
  input   signed [16:0] dinXTwdlf_re;  // sfix17_En13
  input   signed [16:0] dinXTwdlf_im;  // sfix17_En13
  input   dinxTwdlf_vld;
  input   signed [16:0] btf1_re;  // sfix17_En13
  input   signed [16:0] btf1_im;  // sfix17_En13
  input   signed [16:0] btf2_re;  // sfix17_En13
  input   signed [16:0] btf2_im;  // sfix17_En13
  input   btf_vld;
  output  signed [16:0] wrData_re;  // sfix17_En13
  output  signed [16:0] wrData_im;  // sfix17_En13
  output  [4:0] wrAddr;  // ufix5
  output  wrEnb;
  output  signed [16:0] dout_1_8_re;  // sfix17_En13
  output  signed [16:0] dout_1_8_im;  // sfix17_En13
  ...
  reg signed [16:0] SDFCummutator_out_re_next;  // sfix17_En13
  reg signed [16:0] SDFCummutator_out_im_next;  // sfix17_En13
  ...
  reg signed [16:0] SDFCummutator_wrData_re_reg_next;  // sfix17_En13
  reg signed [16:0] SDFCummutator_wrData_im_reg_next;  // sfix17_En13
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [16:0] SDFCummutator_wrXData_re_reg_next;  // sfix17_En13
  reg signed [16:0] SDFCummutator_wrXData_im_reg_next;  // sfix17_En13
  ...
  reg signed [16:0] wrData_re_1;  // sfix17_En13
  reg signed [16:0] wrData_im_1;  // sfix17_En13
  reg [4:0] wrAddr_1;  // ufix5
  reg  wrEnb_1;
  reg signed [16:0] xData_re;  // sfix17_En13
  reg signed [16:0] xData_im;  // sfix17_En13
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [16:0] dout0_re;  // sfix17_En13
  reg signed [16:0] dout0_im;  // sfix17_En13
  reg  dout0_vld;
  wire signed [16:0] xX_re;  // sfix17_En13
  wire signed [16:0] xX_im;  // sfix17_En13
  reg signed [16:0] SDFOutmux_btf2Pipe_re;  // sfix17
  reg signed [16:0] SDFOutmux_btf2Pipe_im;  // sfix17
  reg  SDFOutmux_btfPipe_vld;
  reg signed [16:0] SDFOutmux_btf2Pipe_re_next;  // sfix17_En13
  reg signed [16:0] SDFOutmux_btf2Pipe_im_next;  // sfix17_En13
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [16:0] dout_1_8_re_1;  // sfix17_En13
  reg signed [16:0] dout_1_8_im_1;  // sfix17_En13
  reg  dout_1_8_vld;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_1_8_re_1 = SDFOutmux_btf2Pipe_re;
    dout_1_8_im_1 = SDFOutmux_btf2Pipe_im;
    dout_1_8_vld = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_1_8_re = dout_1_8_re_1;

  assign dout_1_8_im = dout_1_8_im_1;

endmodule  // SDFCommutator1_block6
